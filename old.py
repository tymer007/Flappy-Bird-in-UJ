...
ground_scroll = 0 #ground animation
scroll_speed = 4

background_scroll = 0 #background animation
bg_scroll_speed = 0.1
...
class Bird(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        for num in range(1, 4):
            img = pygame.image.load(f'public/bird{num}.png')
...
# print(pygame.__version__, "Hello World")